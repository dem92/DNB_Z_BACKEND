...
public class CustomerService extends User {
    public CustomerService(int id, String firstName, String lastName, String addressLine1,/* String addressLine2,*/ int postalCode, String eMailAddress, int phoneNumber) {
