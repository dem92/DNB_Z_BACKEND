 ...
 */
public class TransactionFromItem extends LogItem {
    private final int fromAccount;
    private final int toAccount;
    private final int kroner;
    private final int oere;

    public TransactionFromItem(int logCount, int customerID, int fromAccount, int toAccount, int kroner, int oere){
